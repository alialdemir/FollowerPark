<template>
  <div>
    ...
    <section class="container mb-3 pt-24">
      <vx-card>
        <vs-list>
          <vs-list-header title="GİZLİLİK SÖZLEŞMESİ"></vs-list-header>
          <vs-list-item
            title="KULLANIM KURALLARI GİZLİLİK HÜKÜMLERİ SORUMLULUKLAR"
            subtitle="followerpark.com, fiyatlar ve sunulan ürün ve hizmetler üzerinde değişiklik yapma hakkını her zaman saklı tutar."
          ></vs-list-item>
          <vs-list-item
            subtitle="followerpark.com, üyenin sözleşme konusu ürünlerden, teknik arızalar dışında yararlandırılacağını kabul ve taahhüt eder."
          ></vs-list-item>
          <vs-list-item
            subtitle="Müşteri, sitenin kullanımında tersine mühendislik yapmayacağını ya da bunların kaynak kodunu bulmak veya elde etmek amacına yönelik herhangi bir başka işlemde bulunmayacağını kabul ve taahhüt eder."
          ></vs-list-item>
          <vs-list-item
          ...
          ></vs-list-item>
          <vs-list-item
            subtitle="followerpark.com’u ziyaret eden kullanıcıların bilgileri (ziyaret süresi, zamanı, görüntülenen sayfalar) onlara daha iyi hizmet edebilmek amacı ile takip edilmektedir. Bu bilgiler, gizlilik şartlarına bağlı kalınarak, içeriği genişletmek ve iyileştirmek amacı ile reklam vb. konularda işbirliği yaptığımız firmalarla paylaşılmaktadır. Buradaki amaç, sitenin sunduğu deneyimi geliştirmek ve followerpark.com’un geliştirmektir."
          ></vs-list-item>
          <vs-list-item
            subtitle="Kullanıcı, followerpark.com sitesi hizmetlerinden yararlanırken, Türk Ceza Kanunu, Türk Ticaret Kanunu, Fikir ve Sanat Eserleri Kanunu, Marka ve Patent Haklarının Korunması ile ilgili Kanun Hükmünde Kararnameler ve yasal düzenlemeler, Borçlar Yasası, diğer ilgili mevzuat hükümleri ile followerpark.com’un internet sitesi üzerinden hizmetlerine ilişkin olarak yayınlayacağı her türlü duyuru ve bildirimlere uymayı kabul eder. Bu bildirimlere ve yasalara aykırı kullanım sebebiyle doğabilecek hukuki, cezai ve mali her türlü sorumluluk Kullanıcıya aittir."
          ></vs-list-item>
          <vs-list-item
          ...
          ></vs-list-item>
          <vs-list-item
            subtitle="Sitenin güvenliğini tehdit edecek, sitenin çalışmasını engelleyecek yazılımların kullanılması, faaliyetlerin yapılması, yapılmaya çalışılması ve bilgilerin alınması, silinmesi, değiştirilmesi kesinlikle yasaktır."
          ></vs-list-item>
          ...
          <vs-list-item
            subtitle="Bu bilgiler, hedef kitle çalışmalarında kullanılırken diğer kullanıcılara ait bilgilerle birlikte olmak üzere reklam yayıncıları ile paylaşılabilir. Işbu Gizlilik Sözleşmesini kabul ederek bilgilerinizin Reklam yayıncıları ile reklam ve tanıtım amacıyla paylaşılmasına onay vermektesiniz. Bu bilgiler herhangi bir şekilde kişisel bilgi (İsim, soyadı, T.C Kimlik No, cinsiyet, yaş vb.) içermeyip, grup olarak kullanıcı eğilimleri ile ilgili çalışmalar yapmak ve hedef kitleyi segmente etmek amacıyla kullanılmaktadır. Google dahil üçüncü taraf sağlayıcılar, followerpark.com ve followerpark.com’un mobil uygulama reklamlarını internet üzerindeki yayıncı sitelerde yer verdikleri banner alanlarında gösterecektir. Ziyaretçilerin followerpark.com’a ve mobil uygulamaya geçmişte yaptığı ziyaretleri temel alarak reklamlarla ilgili bilgi toplamak, reklamları optimize etmek ve yayınlamak üzere followerpark.com tarafından ve Google dahil üçüncü taraf sağlayıcılarca birinci taraf çerezler ile üç taraf çerezler birlikte kullanılmaktadır."
          ></vs-list-item>
          ...
          <vs-list-item
            ...
            subtitle="İade müşterinin sağlıklı bir gerekçe göstermeleri ve firma yetkilileri tarafından kabul edilmesi ile işleme sokulur."
          ></vs-list-item>
          <vs-list-item
            subtitle="1. Standart paketlerde, müşterinin kullanmadığı günlerin tutarının tamamı iade edilir."
          ></vs-list-item>
          <vs-list-item
            subtitle="2. Standart paketlerimiz dışındaki özel 6 aylık veya 12 aylık paketlerde ise en fazla 2 aylık hizmet tutarı iade edilir. Paket süresinin bitimine 2 aydan daha kısa bir süre kaldıysa kalan süreye tekabül eden tutar iade edilir."
          ></vs-list-item>
          <vs-list-item
            subtitle="3. Müşteri banka hesabına yapılan iadeler 7 gün içerisinde hesaba yansımaktadır."
          ></vs-list-item>
          <vs-list-item
            subtitle="4. Kampanyalar aracılığıyla satın alınan hizmetlerde iade bulunmamaktadır."
          ></vs-list-item>
          <vs-list-item
            subtitle="5. İade işlemi için neden iptal istendiğine dair yazılı ve imzalı bir dilekçe ile info@followerpark.com adresimize mektup gönderilmesi gerekmektedir."
          ></vs-list-item>
          <vs-list-item
            subtitle="6. Hizmet alan tüm kullanıcılarımız yukarıdaki maddeleri kabul etmiş sayılır."
          ></vs-list-item>
        </vs-list>
      </vx-card>
    </section>
